...
```bash
git clone https://github.com/empireenglishcommunity-glitch/Claude.git
cd Claude/empire-challenge-bot
cp .env.example .env
...
Type=simple
User=youruser
WorkingDirectory=/home/youruser/Claude/empire-challenge-bot
Environment=PATH=/home/youruser/Claude/empire-challenge-bot/.venv/bin
ExecStart=/home/youruser/Claude/empire-challenge-bot/.venv/bin/python run.py
Restart=always
RestartSec=10
