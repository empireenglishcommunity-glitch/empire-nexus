...
CHANNEL_GUIDES: dict[str, str] = {
    ...
    "start-here": (
        ...
        "✅ اقرأ بالترتيب: `#welcome` ثم `#rules` ثم `#roles-info`\n"
        "✅ بعد ذلك، اذهب إلى `#bot-commands` واكتب `!join` لتبدأ رسميًا\n"
    ...
    "bot-commands": (
        ...
        "✅ اكتب `!join`, `!done`, `!progress`, `!streak`, وأي أمر آخر\n"
        "✅ اكتب `!مساعدة` أو `!help` لرؤية كل الأوامر المتاحة\n"
    ...
    "support": (
        ...
        "❌ للأسئلة عن محتوى الدروس نفسها، اذهب إلى `#ask-nour` أو `#l0-questions`\n\n"
    ...
    **{
        f"l{level}-showcase": (
            ...
            f"❌ لا تكتب نصًا أو أسئلة هنا — مكانها `#ask-nour` أو `#support`\n\n"
    ...
    "cheat-sheets": (
        ...
        "❌ لا تكتب أسئلة هنا — استخدم `#grammar-qa` أو `#ask-nour`\n\n"
    ...
    "grammar-qa": (
        ...
        "✅ اسأل عن أي قاعدة غير واضحة لك (tenses، prepositions، أي شيء)\n"
