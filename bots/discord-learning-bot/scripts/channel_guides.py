...
CHANNEL_GUIDES: dict[str, str] = {
    ...
    "welcome": (
        ...
        "✅ بعد القراءة، انتقل إلى `#rules`\n"
        "❌ لا تكتب هنا — هذه القناة للقراءة فقط\n\n"
        "إذا لم تفهم شيئًا، اسأل في `#support` في أي وقت."
    ),
    "rules": (
        "📜 **ما هذه القناة؟**\n"
    ...
    # roles-info + start-here entries removed 2026-09-03 (channels deleted —
    # owner decision; onboarding is team-run and the student guide covers this).
    "announcements": (
        "📢 **ما هذه القناة؟**\n"
    ...
    "support": (
        ...
        "❌ للأسئلة عن محتوى الدروس نفسها، اذهب إلى قناة مستواك:\n"
        "`#l0-questions`\n\n"
        "ترد الإدارة عادةً في أقرب وقت ممكن."
    ),
    "suggestions": (
        "💡 **ما هذه القناة؟**\n"
    ...
    **{
        f"{slug}-questions": (
            ...
            + "❌ للمساعدة الشخصية الأشمل، اذهب إلى `#support`\n\n"
    ...
    **{
        f"{slug}-showcase": (
            ...
            f"❌ لا تكتب نصًا أو أسئلة هنا — استخدم `#support` لذلك\n\n"
    ...
    **{
    ...
    "general-chat": (
        ...
        "❌ العربية ممنوعة هنا — تدرّب بالإنجليزية فقط\n\n"
    ...
    "daily-word": (
        ...
        "❌ لا تسأل هنا عن كلمات أخرى — استخدم `#support`\n\n"
    ...
    "grammar-qa": (
        ...
        "❌ للمساعدة الشخصية الأشمل غير القواعد، اذهب إلى `#support`\n\n"
