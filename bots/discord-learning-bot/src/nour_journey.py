...
JOURNEY_MESSAGES = {
    "welcome": (
        ...
        "سنرافقك خطوة بخطوة في رحلة تعلّم الإنجليزية.\n\n"
        "هذا ليس درسًا عاديًا — إنه نظام يومي سيجعلك تتحدث الإنجليزية بثقة.\n\n"
        "💬 أخبرنا: **ما هدفك من تعلّم الإنجليزية؟**\n"
    ...
    "task_intro": (
        ...
        "اذهب إلى قناة `#a1-text-practice` واكتب جملة واحدة بالإنجليزية "
    ...
    "channels_tour": (
        ...
        "📌 **قنوات يومية:**\n"
        "• `#a1-daily-tasks` — مهامك اليومية (تظهر الساعة ٦ صباحًا)\n"
        "• `#bot-commands` — اكتب جميع الأوامر هنا\n"
        "• `#a1-showcase` — أرسل تسجيلاتك الصوتية هنا\n\n"
        "📌 **قنوات مفيدة:**\n"
        ...
        "• `a1-voice-1` — غرفة صوتية للممارسة\n\n"
    ...
    "independent": (
        ...
        "١. افتح `#a1-daily-tasks` صباحًا\n"
        "٢. أنجز المهام السبع\n"
        "٣. التمارين الخمسة الأساسية على منصة التمرين (`!link`) وبتتسجّل تلقائيًا\n"
        "٤. الكتابة `!6` والمجتمع `!7` هنا في Discord\n"
        "٥. شاهد تقدمك: `!progress`\n\n"
...
NUDGE_MESSAGES = {
    ...
    "task_intro": "💡 هل جرّبت كتابة جملة في `#a1-text-practice`؟ أي جملة بسيطة تكفي — مثلًا: \"Hello, I am learning English.\" ثم اكتب `!6` في `#bot-commands`.",
